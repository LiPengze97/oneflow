...
*/
#ifndef ONEFLOW_CORE_JOB_COLLECTIVE_BOXING_OCCL_EXECUTOR_BACKEND_H_
#define ONEFLOW_CORE_JOB_COLLECTIVE_BOXING_OCCL_EXECUTOR_BACKEND_H_
...
class OcclExecutorBackend : public ExecutorBackend {
 public:
  OF_DISALLOW_COPY_AND_MOVE(OcclExecutorBackend);
  OcclExecutorBackend();
  ~OcclExecutorBackend() override;
...
#endif  // ONEFLOW_CORE_JOB_COLLECTIVE_BOXING_OCCL_EXECUTOR_BACKEND_H_
